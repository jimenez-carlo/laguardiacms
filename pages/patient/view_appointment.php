                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="date" name="appointment_date" value="<?= $appointment->appointment_date ?>" class="form-control" id="recipient-name" disabled>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                <label>Remarks:</label>
                                                <textarea name="remarks" class="form-control" id="" cols="3" rows="3" disabled><?= $appointment->remarks ?></textarea>
                                            </div>
                                        </div>
