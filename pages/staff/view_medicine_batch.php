                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" name="name" class="form-control text-uppercase" value="<?= $medicine_batch->expiration_date ?>" disabled>
                                            </div>
                                        </div>
...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <table class="table table-bordered" width="100%" cellspacing="0" id="tbl_equipment">
          ...
          <tbody>
            <?php $tmp_stock = 0 ?>
            <?php foreach (get_all("select ms.* from tbl_medicine_stock_history ms where ms.stock_id = $id order by id asc") as $row) { ?>
              <tr>
                <td><?= sign($row['qty']) ?></td>
            ...
            <?php } ?>
                            ...
                            <div class="d-flex">
                                <a style="margin-left:5px" href="edit_medicine.php?id=<?= $medicine->id ?>" type="button" class="btn btn-primary">Back</a>
                            </div>
                            </form>
