...
extract($_GET);
$medicine = get_one("select * from tbl_medicine_category where id = $id");
 ?>
    ...
    <div class="card-body">
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Medicine Category ID:<?= $id ?></h6>
            </div>
            <div class="card-body">
              <form action="" method="post">
                <input type="hidden" name="table" value="tbl_medicine_category">
