    ...
    <div class="card shadow mb-4">
      ...
      <div class="card-body">
        ...
        <div class="d-flex">
          ...
          <a type="button" class="btn btn-primary" style="margin-left:5px" target="_blank" href="../../generate.php?type=medical_cert&id=<?= $id ?>"> Medical Certificate</a>
          <a type="button" class="btn btn-primary" style="margin-left:5px" target="_blank" href="../../generate.php?type=diagnostic&id=<?= $id ?>"> Medicine Diagnostic</a>
          <button type="button" class="btn btn-primary" style="margin-left:5px" data-toggle="modal" data-target="#createBillModal"> Pay</button>
