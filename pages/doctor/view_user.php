    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <div class="card-body">
                <?php
                if (isset($_GET['id'])) {
                    $userinfo = mysqli_query($conn, "SELECT * FROM " . $_GET['type'] . " WHERE id = '" . $_GET['id'] . "'");
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" name="fname" value="<?= $user['fname']; ?>" class="form-control" id="recipient-name" disabled>
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label>Middle Name:</label>
                                                <input type="text" name="fname" value="<?= $user['mname']; ?>" class="form-control" id="recipient-name" disabled>
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label>Last Name:</label>
                                                <input type="text" name="fname" value="<?= $user['lname']; ?>" class="form-control" id="recipient-name" disabled>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <div class="d-flex">
                                                    <div class="input-group mb-2">
                                                        ...
                                                        <input type="text" name="cn" value="<?= $user['cn']; ?>" class="form-control" id="recipient-name" disabled>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="uname" value="<?= $user['uname']; ?>" class=" form-control" id="recipient-name" disabled>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Email:</label>
                                                <input type="email" name="eml" value="<?= $user['email']; ?>" class=" form-control" id="recipient-name checking_email" disabled>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <div class="d-flex">
                                                    <div class="input-group mb-2">
                                                        <div class="input-group-prepend">
                                                            <button type="button" class="form-control btn btn-primary" id="btn_generate_password" disabled> Generate Password</button>
                                                        </div>
                                                        <input type="password" name="pass" class="form-control" id="password" required value="<?= $user['password']; ?>" disabled>
                                                    </div>
                                                </div>
                                            </div>
...
<?php foreach (get_all("SELECT a.id,a.appointment_date,UPPER(concat(ifnull(d.fname,''), ' ', ifnull(d.mname,''), ' ', ifnull(d.lname,''))) as doctor,
...
where a.patient_id = ".$_GET['id']." and a.status = 'complete' group by a.id
") as $res) { ?>
