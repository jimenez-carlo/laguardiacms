                            ...
                            <form action="../config/code.php" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <select type="text" name="mt" class=" form-control" id="recipient-name" required>
                                        <option value="Tablet" <?= $med['mt'] == 1 ? 'selected' : '' ?>>Tablet</option>
                                        <option value="Capsule" <?= $med['mt'] == 2 ? 'selected' : '' ?>>Capsule</option>
                                        <option value="Bottle" <?= $med['mt'] == 3 ? 'selected' : '' ?>>Bottle</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    <label>Stock:</label>
                                    <input type="text" name="stock" value="<?= $med['stock']; ?>" class=" form-control" id="Show" required>
                                </div>
