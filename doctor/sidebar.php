...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        <a class="nav-link" href="../doctor/appointment.php">
    ...
    <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="../doctor/medicine.php"> <i class="fa-solid fa-hospital"></i>
                    Medicines</a>
                <a class="collapse-item" href="../doctor/lab.php"> <i class="fa-solid fa-stethoscope"></i>
